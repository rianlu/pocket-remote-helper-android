...
public final class Constants {
    ...
    public static final String NSD_TYPE = "_pocketremote._tcp.";
    public static final String NSD_NAME = "PocketRemote";
    public static final String WS_PATH = "/ws";
    public static final String UDP_MAGIC = "PKTREMT1";
    public static final int PROTOCOL_V = 1;
    public static final String ROOT_DIR_NAME = "PocketRemote";
    public static final String DIR_INBOX = "inbox";
    public static final String DIR_APK = "apk";
    public static final String FILE_AUTHORITY = "com.pocketremote.helper.files";
    ...
    public static final String TYPE_CLEAN_OK = "clean_ok";
    ...
    public static final String INJECT_PLUGIN = "plugin";
    public static final String INJECT_ADB = "adb";
    public static final String INJECT_INPUT = "input";
    public static final String INJECT_NONE = "none";
